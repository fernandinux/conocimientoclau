...
logger = configurar_logger(name="LogCosumer", log_dir=FILE_PATH_LOG, nivel=logging.DEBUG)
...
class ExampleConsumer(object):
    ...
    """
    EXCHANGE = "delayed_exchange"   #"frames"  #EXCHANGE_IN
    
    EXCHANGE_TYPE = 'x-delayed-message' #ExchangeType.fanout
    QUEUE = "delredis"    #QUEUE_IN
    ROUTING_KEY = 'delete_frame'
